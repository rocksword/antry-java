...
/**
 * 实现的最大堆的插入和删除操作 <br>
 * http://blog.csdn.net/rocksword/article/details/45484315
 */
public class Heap {
    /**
     * 删除堆中位置是index处的值 操作原理是：当删除节点的数值时，原来的位置就会出现一个孔 填充这个孔的方法就是，把最后的叶子的值赋给该孔，最后把该叶子删除
     * 
     * @param heap
     *            一个最大堆
     */
    ...
    public static void main(String args[]) {
        List<Integer> array = new ArrayList<Integer>(Arrays.asList(null, 1, 2, 5, 10, 3, 7, 11, 15, 17, 20, 9, 15, 8,
                16));
